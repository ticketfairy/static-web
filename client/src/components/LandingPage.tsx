    ...
    <Box bg={bgColor} minH="100vh">
      ...
      <Flex as="header" align="center" justify="space-between" wrap="wrap" padding="1.5rem" maxW="1200px" mx="auto" position="sticky" top="0" bg={bgColor} zIndex="1000">
        <Flex align="center" mr={5}>
          <Heading as="h1" size="lg" letterSpacing={"tighter"} color="purple.500" fontFamily="'Comic Sans MS', cursive, 'CS Gordon', 'Arial Black', 'Helvetica Neue', Arial, sans-serif">
            🧚 Ticket Fairy
          </Heading>
        </Flex>
        ...
        <Button
          ...
          transition="all 0.2s"
          fontFamily="'Comic Sans MS', cursive, 'Roboto', 'Helvetica Neue', Arial, sans-serif"
          fontSize="1rem"
          fontWeight="500"
        >
          Ticket Fairy
      ...
      <Box w="100vw">
        <VStack spacing={4} textAlign="center" py={12} px={4} maxW="1200px" mx="auto">
          ...
          <Text 
            ...
            maxW={"3xl"} 
            fontSize="2xl"
            fontFamily="'Comic Sans MS', cursive, 'Bitcount Grid Double', monospace"
            fontWeight="400"
          >
        ...
        <Box w="full" py={16}>
          <VStack spacing={24} textAlign="center" px={4} maxW="1200px" mx="auto">
            <Heading fontSize={{ base: "2xl", sm: "3xl", md: "4xl" }} color="purple.400" fontFamily="'Comic Sans MS', cursive, 'CS Gordon', 'Arial Black', 'Helvetica Neue', Arial, sans-serif">
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} w="full">
              <Box p={6} shadow="md" borderWidth="1px" borderRadius="lg">
                <VStack spacing={4}>
                  ...
                  <Text fontWeight="bold" fontSize="lg" fontFamily="'Comic Sans MS', cursive, 'CS Gordon', 'Arial Black', 'Helvetica Neue', Arial, sans-serif">
                    Hidden Cavities 🦷 🔍 
                  </Text>
                  <Text color={textColor} textAlign="center" fontFamily="'Comic Sans MS', cursive, 'Roboto', 'Helvetica Neue', Arial, sans-serif">
