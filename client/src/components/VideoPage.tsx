            ...
            <VStack spacing={12} textAlign="center" py={16} px={4} maxW="1400px" mx="auto" flex="1" justify="flex-start" align="center">
                        ...
                        <Alert status="info" borderRadius="xl" bg="blue.50" borderColor="blue.200" borderWidth="1px" p={4}>
                            ...
                            <VStack spacing={2} align="start" flex={1}>
                                ...
                                <Text fontSize="sm" color="blue.700" lineHeight="1.5">
                                    AWS S3 is not configured. Videos will be saved locally only. Set up AWS credentials to enable cloud storage, sharing, and AI ticket generation.
                                </Text>
                            </VStack>
                        </Alert>
                    </Box>
                ...
                <Box w="full" pt={12}>
                    <VStack spacing={8} align="center">
                        ...
                        {listState.isLoading && (
                            <VStack spacing={3}>
                                <Box w={8} h={8} borderRadius="full" border="2px solid" borderColor="purple.200" borderTopColor="purple.500" animation="spin 1s linear infinite" />
                                    ...
                                    <VStack spacing={4}>
                                        ...
                                        <VStack spacing={2}>
                                            ...
                                            <Text fontSize="md" color="gray.500" textAlign="center" lineHeight="1.6">
                                                Create your first video by recording your screen or uploading an existing file. Our AI will analyze it and generate professional tickets.
                                            </Text>
                                        </VStack>
                                    ...
                                    >
                                        <VStack spacing={0} align="stretch" h="full">
                                            ...
                                            >
                                                ...
                                                {/* Duration Badge */}
                                                <Box position="absolute" bottom={3} right={3} bg="blackAlpha.800" color="white" px={2} py={1} borderRadius="md" fontSize="xs" fontWeight="semibold">
                                                    {video.duration}
                                                </Box>
